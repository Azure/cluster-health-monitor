...
print_status "Starting AKS cluster provisioning and cluster-health-monitor deployment"
...
print_status "Validating ACR access..."
...
print_status "Building and pushing cluster-health-monitor image to ACR..."
...
# Deploy cluster-health-monitor
print_status "Deploying cluster-health-monitor..."
